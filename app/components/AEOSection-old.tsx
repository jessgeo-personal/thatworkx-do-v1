      ...
      <div className="container-custom max-w-6xl">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap items-center gap-8 mb-6">
            <div>
              <span className="text-[10px] text-gray-300 block mb-1">for Business Users</span>
              <Image
            ...
            <div>
              <span className="text-[10px] text-gray-300 block mb-1">for Technical Users</span>
              <Image
            ...
            <div>
              <span className="text-[10px] text-gray-300 block mb-1">for Social Content Managers &amp; Influencers</span>
              <Image
