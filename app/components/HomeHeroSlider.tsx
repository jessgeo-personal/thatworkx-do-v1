...
export default function HomeHeroSliderNew() {
  ...
  const totalSlides = 3 // 3 Business Verticals: AEO, RPost, Cryptomonkey
  ...
  return (
    <div className="relative min-h-[620px] bg-[#090a0f] text-white overflow-hidden selection:bg-[#b7410e] selection:text-white">
      
      {/* =========================================================================
          SLIDE 1: AEO TOOLS (AI-READY & AI-OPTIMIZED BRAND ELEVATION)
          ========================================================================= */}
      {currentSlide === 0 && (
        <section className="bg-gradient-to-br from-[#090a0f] via-slate-950 to-[#090a0f] text-white py-14 md:py-16 min-h-[620px] flex items-center">
          <div className="container-custom mx-auto px-4 w-full">
            
            {/* Slide 1 Headline */}
            <div className="max-w-4xl mx-auto text-center mb-10">
              <span className="inline-block bg-[#b7410e]/15 border border-[#b7410e]/40 text-[#f59e0b] text-xs font-bold px-3.5 py-1 rounded-full uppercase tracking-wider mb-3 font-mono">
                AI-Readiness Tools for your Web Presence (AEO and GEO)
              </span>
              <h1 className="text-3xl md:text-5xl font-heading font-extrabold mb-3 leading-tight text-white">
                Be Found, Trusted, and Cited by <span className="text-[#f59e0b]">AI engines </span>
              </h1>
              <p className="text-sm md:text-base text-gray-300 max-w-2xl mx-auto font-light">
                Essential tools for every role to ensure AI Search Recommends Your Business, Not Your Competitors.
              </p>
            </div>

            {/* 3 Minimalist Persona Cards (Clean Outcome-Driven Layout) */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto text-left">
              ...
              <div className="bg-[#16181D]/90 border border-white/10 hover:border-sky-500/50 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between shadow-2xl group">
                <div>
                  {/* Prominent Persona Eyebrow */}
                  <div className="mb-3">
                    <span className="text-md font-bold font-mono uppercase tracking-wider text-sky-400 block mb-1">
                      For Business Users &amp; Marketers
                    </span>
                    {/*<span className="text-[15px] font-mono font-semibold px-2 py-0.5 rounded bg-sky-500/10 text-sky-300 border border-sky-500/20 inline-block"> 
                      Diagnostic Engine
                    </span> */}
                  </div>

                  {/* Logo */}
                  <div className="h-17 flex items-center mb-3">
                    <Image
                ...
                <Link
                  href="/aeo"
                  className="w-full text-center py-2.5 bg-white/10 hover:bg-white text-white hover:text-black font-bold text-xs rounded-xl transition-all border border-white/10"
                >
              ...
              <div className="bg-[#16181D]/90 border border-white/10 hover:border-amber-500/50 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between shadow-2xl group">
                <div>
                  {/* Prominent Persona Eyebrow */}
                  <div className="mb-3">
                    <span className="text-md font-bold font-mono uppercase tracking-wider text-amber-400 block mb-1">
                      For Web Developers &amp; Technical Users
                    </span>
                    {/* <span className="text-[15px] font-mono font-semibold px-2 py-0.5 rounded bg-amber-500/10 text-amber-300 border border-amber-500/20 inline-block">
                      Prescriptive Fixer
                    </span>*/}
                  </div>
                ...
                <a
                  ...
                  className="w-full text-center py-2.5 bg-[#b7410e] hover:bg-[#d45d2a] text-white font-bold text-xs rounded-xl transition-all shadow-lg shadow-[#b7410e]/20"
                >
                  Launch AIOptimize →
                </a>
              </div>
              ...
              <div className="bg-[#16181D]/90 border border-white/10 hover:border-rose-500/50 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between shadow-2xl group">
                <div>
                  {/* Prominent Persona Eyebrow */}
                  <div className="mb-3">
                    <span className="text-md font-bold font-mono uppercase tracking-wider text-rose-400 block mb-1">
                      For Social Content Managers &amp; Influencers
                    </span>
                    {/* <span className="text-[15px] font-mono font-semibold px-2 py-0.5 rounded bg-rose-500/10 text-rose-300 border border-rose-500/20 inline-block">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {currentSlide === 1 && (
        <section className="bg-gradient-to-br from-red-950 via-[#090a0f] to-slate-950 text-white py-20 min-h-[620px] flex items-center">
          <div className="container-custom mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div className="text-center md:text-left">
                ...
                <Link href="/cybersecurity" className="btn-primary bg-[#b7410e] hover:bg-[#d45d2a] text-white font-bold inline-block text-xs py-3 px-6 rounded-xl">
                  Explore RPost Suite →
                </Link>
              </div>
              ...
              <div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-[#16181D] rounded-xl border border-white/10">
                    <Image src="/images/rpost/rmail-logo.png" alt="RMail" width={140} height={50} className="mx-auto mb-2" />
                    <p className="text-xs text-gray-300 font-semibold">Email Security &amp; Encryption</p>
                  </div>
                  <div className="text-center p-4 bg-[#16181D] rounded-xl border border-white/10">
                    <Image src="/images/rpost/rsign-logo.png" alt="RSign" width={140} height={50} className="mx-auto mb-2" />
                    <p className="text-xs text-gray-300 font-semibold">Legal e-Signatures</p>
                  </div>
                  <div className="text-center p-4 bg-[#16181D] rounded-xl border border-white/10">
                    <Image src="/images/rpost/rdocs-logo.png" alt="RDocs" width={140} height={50} className="mx-auto mb-2" />
                    <p className="text-xs text-gray-300 font-semibold">Document Rights Security</p>
                  </div>
                  <div className="text-center p-4 bg-[#16181D] rounded-xl border border-white/10">
                    <Image src="/images/rpost/raptorai-logo.png" alt="RaptorAI" width={140} height={50} className="mx-auto mb-2" />
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {currentSlide === 2 && (
        <section className="bg-gradient-to-br from-slate-950 via-emerald-950/20 to-[#090a0f] text-white py-20 min-h-[620px] flex items-center">
          <div className="container-custom mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div className="flex flex-col items-center text-center">
                ...
                <Image
                  ...
                  className="mb-6"
                />
                <a href="#crypto" className="btn-primary bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs py-3 px-6 rounded-xl">
